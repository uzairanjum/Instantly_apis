...
class Summary:
    def __init__(self, campaign_id):
        ...
        self.organization_name = self.get_campaign_details()
    ...
    def update_weekly_summary(self):
        ...
        update_weekly_summary_report(self.campaign_id, self.organization_name, csv_name, worksheet_name)
    ...
    def update_daily_summary(self):
        ...
        logger.info(f"organization_name: {self.organization_name}, csv_name: {csv_name}, worksheet_name: {worksheet_name}")
        update_daily_summary_report(self.campaign_id, self.organization_name, csv_name, worksheet_name)
    ...
    def get_campaign_details(self):
        organization_name, _, _ = get_campaign_details(self.campaign_id)
